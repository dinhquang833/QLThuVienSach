package quangndph27050.fpoly.damthvinpn.database;
...
public class DbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String dbThanhVien = "CREATE TABLE THANHVIEN(matv integer primary key autoincrement, hoten text, namsinh text, gioitinh text)";
        ...
        sqLiteDatabase.execSQL("INSERT INTO THANHVIEN VALUES (1,'Cao Thu Trang','2000','Nữ'),(2,'Nguyễn Đình Quang','2000','Nam')");
